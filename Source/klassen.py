class Kleurenwiezen():
    ...
    def update_score(self, speler, spel, vrager, gelukt, overslagen=0):
        ...
        puntenverdeling_vrager_mislukt ={
            "Samen 8": {"vrager": [0, -10, -13, -16, -19, -22], "niet_vrager": [0, 10, 13, 16, 19, 22]},
            "Solo 5": {"vrager": [0, -12, -15, -18, -21, -24],"niet_vrager": [0, 4, 5, 6, 7, 8]},
            "Samen 9": {"vrager": [0, -13, -16, -19, -22, -25], "niet_vrager": [0, 13, 16, 19, 22, 25]},
            "Solo 6": {"vrager": [0, -15, -18, -21, -24, -27], "niet_vrager": [0, 5, 6, 7, 8, 9]},
            "Samen 10": {"vrager": [0, -16, -19, -22, -25], "niet_vrager": [0, 16, 19, 22, 25]},
            "Solo 7": {"vrager": [0, -18, -21, -24, -27, -30], "niet_vrager": [0, 6, 7, 8, 9, 10]},
            "Samen 11": {"vrager": [0, -19, -22, -25, -28, -31], "niet_vrager": [0, 19, 22, 25, 28, 31]},
            "Kleine miserie": {"vrager": [-18], "niet_vrager": [6]},
            "Samen 12": {"vrager": [0, -22, -25, -28, -31, -34], "niet_vrager": [0, 22, 25, 28, 31, 34]},
            "Solo 8": {"vrager": [0, -21, -24, -27, -30, -33], "niet_vrager": [7, 8, 9, 10, 11]},
            "Samen 13": {"vrager": [0, -30, -33, -36, -39, -42, -45 ], "niet_vrager": [0, 30, 33, 36, 39, 42, 45]},
            "Abondance 9": {"vrager": [33], "niet_vrager": [-11]},
